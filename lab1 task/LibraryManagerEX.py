#Initialize wmpty lists, set and dictionary
books_list=[]
authors_set=set()
books_dict={}
...
authors_set.add("Jane Smith")
books_dict["Python Fundamentals"]="Jane Smith"
...
if search_title in books_dict:
    print(f"Books found! The Author of the book {search_title} is {books_dict[search_title]}")
else:
